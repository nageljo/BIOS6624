...
As shown in *Table 1*, hard drug users in the analysis dataset had generally higher adherence ($97\%$ with $\ge 95\%$ adherence) than non-hard drug users ($89\%$ with $\ge 95\%$ adherence). Additionally of note, among hard drug users, only 1 subject did not have $\ge 95\%$ adherence to the study protocol. Model estimates for hard drug use with and without adjusting for adherence are shown in *Table 3* (Bayesian) and *Table 4* (frequentist). 
