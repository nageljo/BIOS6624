...
hiv_analysis %>%
  ...
  mutate(
    outcome = factor(
      ...
      labels = c("SF-36 MCS", "SF-36 PCS", "CD4+ T Cell Count", "Log Viral Load")
    )
  ) %>%
  ...
  labs(
    ...
    x = NULL, # Removes the redundant "hard_drugs_baseline" axis title
