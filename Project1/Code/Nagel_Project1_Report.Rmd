...
Convergence was further assessed by plotting each parameter's density for each chain. Additionally, trace and autocorrelation plots were visually inspected to evaluate chain mixing and sample dependency.
